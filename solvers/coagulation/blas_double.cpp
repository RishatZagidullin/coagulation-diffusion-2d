...
void gemv(const CBLAS_ORDER order, const CBLAS_TRANSPOSE TransA, const int M, const int N, const double alpha, const float *A, const int lda, const float *X, const int incX, const double beta, float *Y, const int incY)
{
