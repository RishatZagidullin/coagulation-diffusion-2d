...
void gemv(const CBLAS_ORDER, const CBLAS_TRANSPOSE, const int, const int, const double, const float *, const int, const float *, const int, const double, float *, const int);
